...
void Model::populateDisplacementMap()
{
    ...
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,0.1}, {0.0, 0.0})); //COUNT
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,-0.1}, {0.0, 0.0})); //CLOCK
    ...
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,0.15}, {0.0, 0.0})); //COUNT
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,-0.15}, {0.0, 0.0})); //CLOCK
    ...
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,0.2}, {0.0, 0.0})); //COUNT
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,-0.2}, {0.0, 0.0})); //CLOCK
    ...
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,0.25}, {0.0, 0.0})); //COUNT
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,-0.25}, {0.0, 0.0})); //CLOCK
    ...
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,0.3}, {0.0, 0.0})); //COUNT
    m_displacementMap.insert(std::pair<VelocityCmd, Displacement>({0,0,-0.3}, {0.0, 0.0})); //CLOCK
