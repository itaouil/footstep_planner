...
void Model::setModelsCoefficients() {
    ...
    m_fr_rl_com_x << 1.02580782e-01, -8.32667268e-17,  0.00000000e+00,
            ...
            -5.20161757e-02,  8.79474283e-01, 0.16429143;

    m_fr_rl_com_y.resize(15);
    m_fr_rl_com_y << -1.55767863e-02,  8.67361738e-18,  2.77555756e-17,
            ...
            7.36974372e-02,  1.58760602e-01, 0.08117934;

    m_fr_rl_com_theta.resize(15);
    m_fr_rl_com_theta << 2.78465412e-03, -3.07913417e-17,  1.38777878e-17,
            ...
            -3.89728024e-02, -5.65290178e-02, -0.0318934;

    // CoM models coefficients when FL/RR are swinging
    m_fl_rr_com_x.resize(15);
    m_fl_rr_com_x << 1.10969766e-01, -1.11022302e-16, -4.44089210e-16,
            ...
            -5.70401960e-01, -7.66127094e-01, -0.18558678;

    m_fl_rr_com_y.resize(15);
    m_fl_rr_com_y << 6.68522783e-03,  8.67361738e-18, -4.43438689e-17,
            ...
            2.74425862e-02, -2.54936571e-01, 0.03697627;

    m_fl_rr_com_theta.resize(15);
    m_fl_rr_com_theta << -8.06173264e-03,  2.49366500e-17,  1.73472348e-18,
            ...
            5.74811800e-02,  1.04968675e-01, 0.0439839;

    // FL models coefficients
    m_fl_swinging_x.resize(15);
    m_fl_swinging_x << 1.82526943e-01, -2.22044605e-16, -8.88178420e-16,
            ...
            -1.03104398e+00, -1.21301433e+00, -0.15264197;

    m_fl_swinging_y.resize(15);
    m_fl_swinging_y << 1.54493347e-02,  8.50014503e-17, -1.04950770e-16,
            ...
            -3.51879717e-03, -6.24527102e-01, 0.1045548;

    // FR models coefficients
    m_fr_swinging_x.resize(15);
    m_fr_swinging_x << 1.79641731e-01, -5.55111512e-16, -2.22044605e-16,
            ...
            -2.27021789e-01,  1.08520770e+00, 0.36820251;
    m_fr_swinging_y.resize(15);
    m_fr_swinging_y << -3.00089106e-02, -3.46944695e-18, -3.98986399e-16,
            ...
            3.23640331e-02,  3.12807929e-01, 0.13049389;

    // RL models coefficients
    m_rl_swinging_x.resize(15);
    m_rl_swinging_x << 1.81035817e-01, -7.77156117e-16, -2.22044605e-16,
            ...
            -2.17096235e-01,  1.04456496e+00, -0.11744163;
    m_rl_swinging_y.resize(15);
    m_rl_swinging_y <<  -3.00089106e-02, -3.46944695e-18, -3.98986399e-16,
            2.18679815e-02,  1.11022302e-16,  0.00000000e+00,
            1.29802972e-01,  3.24624063e-01, -1.46975517e-01,
            -8.02841269e-01,  2.18336898e-01, -1.36810493e+00,
            3.23640331e-02,  3.12807929e-01, 0.13049389;
    ...
    m_rr_swinging_x << 1.83698516e-01, -2.22044605e-16, -2.22044605e-16,
            ...
            -2.00363021e+00, -1.28881520e+00, -0.63309639;
    m_rr_swinging_y.resize(15);
    m_rr_swinging_y <<  9.38344530e-03, -1.90819582e-17, -1.49619900e-16,
            ...
            7.44317352e-03, -1.11908575e+00, -0.01373425;
}
