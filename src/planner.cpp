...
void Planner::getFeetConfiguration(const bool &p_swingingFRRL,
    ...
    ROS_DEBUG_STREAM("Planner: " << l_feetPredictionWorldFrame[0] << " ," << l_feetPredictionWorldFrame[1]);
    ROS_DEBUG_STREAM("Planner: " << l_feetPredictionWorldFrame[2] << " ," << l_feetPredictionWorldFrame[3]);
    ...
    // // Feet poses w.r.t CoM
    // p_feetConfiguration.flCoM.x = std::abs(p_feetConfiguration.flMap.x - p_robotPose.pose.pose.position.x);
    // p_feetConfiguration.flCoM.y = std::abs(p_feetConfiguration.flMap.y - p_robotPose.pose.pose.position.y);
    // p_feetConfiguration.frCoM.x = std::abs(p_feetConfiguration.frMap.x - p_robotPose.pose.pose.position.x);
    // p_feetConfiguration.frCoM.y = -std::abs(p_feetConfiguration.frMap.y - p_robotPose.pose.pose.position.y);
    // p_feetConfiguration.rlCoM.x = -std::abs(p_feetConfiguration.rlMap.x - p_robotPose.pose.pose.position.x);
    // p_feetConfiguration.rlCoM.y = std::abs(p_feetConfiguration.rlMap.y - p_robotPose.pose.pose.position.y);
    // p_feetConfiguration.rrCoM.x = -std::abs(p_feetConfiguration.rrMap.x - p_robotPose.pose.pose.position.x);
    // p_feetConfiguration.rrCoM.y = -std::abs(p_feetConfiguration.rrMap.y - p_robotPose.pose.pose.position.y);
