...
const std::string TARGET_GOAL_TOPIC("/spot_navigation/goal");
const std::string PREDICTED_CoM_PATH_TOPIC("/predicted_com_path");
const std::string VELOCITY_CMD_TOPIC("/spot/wb_controller/joy");
...
// Subscribed topics
const std::string ROBOT_POSE_TOPIC("/spot/ground_truth");
const std::string FL_FOOT_POSE_TOPIC("/spot/wb_controller/lf_foot");
const std::string FR_FOOT_POSE_TOPIC("/spot/wb_controller/rf_foot");
const std::string RL_FOOT_POSE_TOPIC("/spot/wb_controller/lh_foot");
const std::string RR_FOOT_POSE_TOPIC("/spot/wb_controller/rh_foot");
const std::string HEIGHT_MAP_TOPIC("/elevation_mapping/elevation_map_raw");
const std::string CONTACT_FORCES_TOPIC("/spot/wb_controller/contact_forces");
