...
const int HEIGHT_MAP_MAX_SIZE_X(static_cast<int>(HEIGHT_MAP_LENGTH_X/HEIGHT_MAP_RESOLUTION) + 1);
const int HEIGHT_MAP_MAX_SIZE_Y(static_cast<int>(HEIGHT_MAP_LENGTH_Y/HEIGHT_MAP_RESOLUTION) + 1);